                ...
                <main class="col-12 col-md-9 col-xl-10 py-md-3 pl-md-5 bd-content">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            ...
                            <input id="name"  name="name" type="text" class="form-control" aria-label="Default" value ="{{ $name }}" aria-describedby="inputGroup-sizing-default">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroup-sizing-default">Link</span>
                        </div>
                            <input id="link" type="text" name="link"  class="form-control" aria-label="Default" value ="{{ $value }}"aria-describedby="inputGroup-sizing-default">
					</div>
                    <div class="form-group">
                        <textarea id="title" class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="在这里输入资源简介">{{ $title }}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-6">
